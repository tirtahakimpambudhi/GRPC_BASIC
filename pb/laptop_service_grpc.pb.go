...
type LaptopServiceClient interface {
	...
	GetAllLaptop(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ResponsesLaptop, error)
...
func (c *laptopServiceClient) GetAllLaptop(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ResponsesLaptop, error) {
...
func (c *laptopServiceClient) DeleteLaptopByID(ctx context.Context, in *ResponseRequestByID, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *laptopServiceClient) UploadImageLaptop(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[1], "/LaptopService/UploadImageLaptop", opts...)
	if err != nil {
		return nil, err
	}
	x := &laptopServiceUploadImageLaptopClient{stream}
	return x, nil
}

type LaptopService_UploadImageLaptopClient interface {
	Send(*UploadImageRequest) error
	CloseAndRecv() (*UploadImageResponse, error)
	grpc.ClientStream
}

type laptopServiceUploadImageLaptopClient struct {
	grpc.ClientStream
}

func (x *laptopServiceUploadImageLaptopClient) Send(m *UploadImageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *laptopServiceUploadImageLaptopClient) CloseAndRecv() (*UploadImageResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type LaptopServiceServer interface {
	...
	GetAllLaptop(context.Context, *empty.Empty) (*ResponsesLaptop, error)
...
func (UnimplementedLaptopServiceServer) GetAllLaptop(context.Context, *empty.Empty) (*ResponsesLaptop, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllLaptop not implemented")
}
func (UnimplementedLaptopServiceServer) DeleteLaptopByID(context.Context, *ResponseRequestByID) (*empty.Empty, error) {
...
func _LaptopService_GetAllLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LaptopServiceServer).GetAllLaptop(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LaptopService_UploadImageLaptop_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LaptopServiceServer).UploadImageLaptop(&laptopServiceUploadImageLaptopServer{stream})
}

type LaptopService_UploadImageLaptopServer interface {
	SendAndClose(*UploadImageResponse) error
	Recv() (*UploadImageRequest, error)
	grpc.ServerStream
}

type laptopServiceUploadImageLaptopServer struct {
	grpc.ServerStream
}

func (x *laptopServiceUploadImageLaptopServer) SendAndClose(m *UploadImageResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *laptopServiceUploadImageLaptopServer) Recv() (*UploadImageRequest, error) {
