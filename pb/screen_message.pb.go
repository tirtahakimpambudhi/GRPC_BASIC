...
type Screen struct {
	...
	Resolution *Screen_Resulotion `protobuf:"bytes,2,opt,name=resolution,proto3" json:"resolution,omitempty"`
...
func (x *Screen) GetResolution() *Screen_Resulotion {
	if x != nil {
		return x.Resolution
	}
	return nil
...
func (x *Screen_Resulotion) Reset() {
	*x = Screen_Resulotion{}
	if protoimpl.UnsafeEnabled {
...
func (x *Screen_Resulotion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Screen_Resulotion) ProtoMessage() {}

func (x *Screen_Resulotion) ProtoReflect() protoreflect.Message {
	mi := &file_screen_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Screen_Resulotion.ProtoReflect.Descriptor instead.
func (*Screen_Resulotion) Descriptor() ([]byte, []int) {
	return file_screen_message_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Screen_Resulotion) GetWidth() uint32 {
	if x != nil {
		return x.Width
	}
	return 0
...
func (x *Screen_Resulotion) GetHeight() uint32 {
	if x != nil {
		return x.Height
	}
	return 0
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69,
	...
	0x6c, 0x74, 0x69, 0x54, 0x6f, 0x75, 0x63, 0x68, 0x1a, 0x3a, 0x0a, 0x0a, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x77, 0x69, 0x64, 0x74, 0x68, 0x18,
	...
	0x53, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x05, 0x5a,
...
var file_screen_message_proto_goTypes = []interface{}{
	...
	(*Screen)(nil),            // 1: Screen
	(*Screen_Resulotion)(nil), // 2: Screen.Resulotion
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: Screen.resolution:type_name -> Screen.Resulotion
...
func file_screen_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_screen_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Screen_Resulotion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
